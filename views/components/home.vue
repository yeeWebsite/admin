...
export default {
  data() {
    return {
      update:[
        {date: '2017/06/11', msg: '1,修复issue后台bug（桌型添加桌号，桌型只可选择2,4,6,12，修复订单处理异常问题， 等）;<br> 2,添加菜系，菜肴分类，口味分类管理;<br> 3,新增门店账号管理'},
        {date: '2017/06/06', msg: '1,添加登录，退出登录等功能（管理员用户：sysadmin 123456; 门店用户：test 123456）;<br> 2,添加用户目录权限;<br> 3,预售订单操作功能'},
        {date: '2017/06/05', msg: '1,预售订单列表查询已更新;'},
