...
export default {
  ...
  methods: {
    ...
    getOrderlist(){
      ...
      const params = { startime: startime, endtime: endtime, shopid: this.fontshopid, orderid: this.ordersearch, page: this.page, pagesize: this.pagesize, ordertype:2 };
    ...
    downloadList(){
      ...
      const params = {shopid: this.downshopid, ordertype: 2, startime: startime, endtime: endtime, indicator:{async: true}};
